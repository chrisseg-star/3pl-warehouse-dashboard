(function(){
  ...
  var SLA_SPECS={
    US:{months:['November 2025','December 2025','January 2026','February 2026','March 2026','April 2026','May 2026','June 2026','July 2026','August 2026'],
  ...
  function periodShortLabel(p){
    if(p==='Past 10 Months (Nov25-Aug26)') return 'PAST 10 MO';
  ...
  var MONTH_TO_SLA_PERIOD={'Jun 2026':'June 2026','Jul 2026':'July 2026','Aug 2026':'August 2026'};
  function slaCompliancePct(period,warehouse,brand){
    var spec=SLA_SPECS[warehouse];
    if(!spec) return null;
    var isAgg=(period==='Past 10 Months (Nov25-Aug26)'||period==='YTD 2026');
  ...
  function renderSLA(brand){
    ...
    var aggPeriods=slaWarehouse==='US'?['Past 10 Months (Nov25-Aug26)']:[];
    ...
    var footnotes='<div style="font-size:11px; color:#9A988F; margin-top:10px;">Real data from your SLA Tracking export. US covers Nov 2025–Aug 2026 across 3 brands; CA, UK, and EU only have Jun–Jul 2026 for Big Fudge Vinyl so far, with most columns not yet reported — coming soon as more months and brands land.</div>';
    if(slaWarehouse==='US'){
      var p9Row=rowFor('Past 10 Months (Nov25-Aug26)');
      if(p9Row&&typeof p9Row[11]==='number'){
        footnotes+='<div style="margin-top:8px; font-size:12px; color:#6B6A63;">Absolute net adjustment rate (target &lt;=0.5%, Past 10 Months, '+displayBrand(brand)+'): <strong style="color:#1F1F1D;">'+(p9Row[11]*100).toFixed(2)+'%</strong></div>';
      }
    }
  ...
  function renderSlaInboundTab(){
    ...
    return '<div style="font-size:11.5px; color:#9A988F; margin-bottom:2px;">Order-level detail from your UNIS in/out export, Nov 2025–Aug 2026. Date range filters by In-Yard Date.</div>'+
  ...
  function renderSlaOutboundTab(){
    ...
    return '<div style="font-size:11.5px; color:#9A988F; margin-bottom:2px;">Order-level detail from your UNIS in/out export, Nov 2025–Aug 2026. Date range filters by Order Date.</div>'+
  ...
  function renderSlaTopOffenders(){
    if(slaWarehouse!=='US'||typeof window.SLA_ORDERS_US==='undefined') return comingSoonPanel();
    var d=window.SLA_ORDERS_US;
    return '<div style="font-size:11.5px; color:#9A988F; margin-bottom:2px;">The 10 slowest inbound receipts and 10 slowest B2B outbound shipments, Nov 2025–Aug 2026. Click a row to see its SKU breakdown.</div>'+
